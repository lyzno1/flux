...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: stack frame parsing requires multiple regex patterns
...
export const StackTraceActions = memo(({ className, children, ...props }: StackTraceActionsProps) => (
	// biome-ignore lint/a11y/useSemanticElements: grouping container for action buttons
	<div
