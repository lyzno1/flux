...
export const PromptInputTextarea = ({
	...
	// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: keyboard handling requires many conditional branches
...
export const PromptInputActionMenuTrigger = ({ className, children, ...props }: PromptInputActionMenuTriggerProps) => (
	<DropdownMenuTrigger render={<PromptInputButton aria-label="Open menu" className={className} {...props} />}>
