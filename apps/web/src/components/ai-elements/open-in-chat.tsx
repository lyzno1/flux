...
const providers = {
	...
	scira: {
		...
		icon: (
			<svg aria-hidden="true" className="size-4" fill="none" viewBox="0 0 910 934" xmlns="http://www.w3.org/2000/svg">
	...
	cursor: {
		...
		icon: (
			<svg aria-hidden="true" className="size-4" viewBox="0 0 466.73 532.09" xmlns="http://www.w3.org/2000/svg">
				<title>Cursor</title>
				<path
