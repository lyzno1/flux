...
const providers = {
	...
	claude: {
		...
		icon: (
			<svg aria-hidden="true" fill="currentColor" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
				<title>Claude</title>
				<path
					clipRule="evenodd"
	...
	v0: {
		...
		icon: (
			<svg aria-hidden="true" fill="currentColor" viewBox="0 0 147 70" xmlns="http://www.w3.org/2000/svg">
				<title>v0</title>
	...
	cursor: {
		...
		icon: (
			<svg aria-hidden="true" version="1.1" viewBox="0 0 466.73 532.09" xmlns="http://www.w3.org/2000/svg">
				<title>Cursor</title>
				<path
		...
		<DropdownMenuItem
			...
			render={
				<a className="flex items-center gap-2" href={providers.chatgpt.createUrl(query)} rel="noopener" target="_blank">
					<span className="sr-only">{providers.chatgpt.title}</span>
				</a>
			}
			nativeButton={false}
		>
		...
		<DropdownMenuItem
			...
			render={
				<a className="flex items-center gap-2" href={providers.claude.createUrl(query)} rel="noopener" target="_blank">
					<span className="sr-only">{providers.claude.title}</span>
				</a>
			}
			nativeButton={false}
		>
		...
		<DropdownMenuItem
			...
			render={
				<a className="flex items-center gap-2" href={providers.t3.createUrl(query)} rel="noopener" target="_blank">
					<span className="sr-only">{providers.t3.title}</span>
				</a>
			}
			nativeButton={false}
		>
		...
		<DropdownMenuItem
			...
			render={
				<a className="flex items-center gap-2" href={providers.scira.createUrl(query)} rel="noopener" target="_blank">
					<span className="sr-only">{providers.scira.title}</span>
				</a>
			}
			nativeButton={false}
		>
		...
		<DropdownMenuItem
			...
			render={
				<a className="flex items-center gap-2" href={providers.v0.createUrl(query)} rel="noopener" target="_blank">
					<span className="sr-only">{providers.v0.title}</span>
				</a>
			}
			nativeButton={false}
		>
		...
		<DropdownMenuItem
			...
			render={
				<a className="flex items-center gap-2" href={providers.cursor.createUrl(query)} rel="noopener" target="_blank">
					<span className="sr-only">{providers.cursor.title}</span>
				</a>
			}
			nativeButton={false}
		>
